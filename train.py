# -*- coding: utf-8 -*-
"""SIA_baseline(edit)_Lv2_resnext101.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1EnaD2SJr9DsHpGHqVG-1hlHcWXpisHKI

# 인코더 & 모델 : se_resnext101_32_4d & UnetPlusPlus
...
building_train_path = os.path.join(workspace_path, 'LV2_dataset_edit/LV2_training_set')
x_train_dir = os.path.join(building_train_path, 'images')
y_train_dir = os.path.join(building_train_path, 'labels/building_road')

building_train_path = os.path.join(workspace_path, 'LV2_dataset_edit/LV2_validation_set')
x_valid_dir = os.path.join(building_train_path, 'images')
y_valid_dir = os.path.join(building_train_path, 'labels/building_road')
...
dataset = Dataset(x_train_dir, y_train_dir, classes=['building', 'road'])
